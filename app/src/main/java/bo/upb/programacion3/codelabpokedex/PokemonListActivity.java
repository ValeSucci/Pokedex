...
public class PokemonListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] pokemonIdList = userLogged.getFavoritos();
        PokemonUtils pokemonUtils = new PokemonUtils();
        final List<Pokemon> pokemonList = pokemonUtils.getPokemons(pokemonIdList);
